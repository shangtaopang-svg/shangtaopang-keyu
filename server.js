...
function getWorks() {
  return [
    ...
    { id: 3, title: 'shangtaopang-可与·记', desc: '个人网站与AI学习平台，集成视频分析、思维导图、笔记功能。', url: 'http://localhost:3000', icon: '🤖', tags: ['Node.js', 'AI分析', '学习管理'], detail: '个人品牌站，聚合多平台AI学习视频，智能分类、自动分析、思维导图、学习笔记、学习进度追踪。', highlights: ['多平台AI视频聚合', '智能分类与自动分析', '思维导图生成', '学习进度追踪'], techs: ['Node.js', 'Express', 'SQLite', 'Puppeteer', 'EJS'] },
